...
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, numberOfDays, i, year, _a, month, _b, day, _c, nextDayButton, events, _i, events_1, event_1, title, description, time, location_1, eventObject, e_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 14:
                    ...
                    event_1 = events_1[_i];
                    return [4 /*yield*/, event_1.$eval(".event-info-box-title-link", function (title) { return title.innerText; })];
                case 15:
                    title = _d.sent();
                    return [4 /*yield*/, event_1.$eval(".event-info-box-description", function (description) { return description.innerText; })];
                case 16:
                    description = _d.sent();
                    return [4 /*yield*/, event_1.$eval(".event-info-box-date", function (time) { return time.innerText; })];
                case 17:
                    time = _d.sent();
                    return [4 /*yield*/, event_1.$eval(".event-info-box-venue", function (location) { return location.innerText; })];
                case 18:
                    location_1 = _d.sent();
                    eventObject = {
                        year: year,
